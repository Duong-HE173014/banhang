            ...
            <section class="home-section">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">                                                     
                            <span>
                                <form action="staffdashboardcontrol" method="post" class="form-inline my-2 my-lg-0">
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach var="order" items="${orderList}">
                            ...
                            <td>${order.status}</td>
                            <form action="staffdashboardcontrol" method="post">
                                ...
                                <td><button type="submit" name="submit" class="btn btn-primary"type="submit" name="submit">Delivering</button></td>
                            </form>
