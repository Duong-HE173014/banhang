    ...
    <head>
        ...
        <script>
            $(function () {
             ...
             document.getElementById('dateRangeForm').onsubmit = function() {
                    ...
                    <tbody>
                        <c:forEach var="order" items="${orderList}">
                            <tr>
                                ...
                                <td>${order.status}</td>
                                <td class="align-items-center"> <a href="salerOrderDetailControl?orderId=${order.orderId}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-circle-fill" viewBox="0 0 16 16">
