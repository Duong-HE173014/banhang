...
public class VerifyControl extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (otp.equals(checkOtp)) {
            ...
            boolean registrationSuccessful = new UserDAO().registerUser(user.getFullName(), user.getEmail(), user.getPassword(), user.getRole(), user.isGender(), user.getAddress(), user.getPhone());
