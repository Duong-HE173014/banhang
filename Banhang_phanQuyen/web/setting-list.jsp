...
<html>
    ...
    <body>
                ...
                <tbody>
                    <c:forEach var="setting" items="${settingList}">
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editSettingModal_${setting.getSettingID()}">Edit</button>
                            </td>
                        </tr>
                        <!-- Edit Setting Modal -->
        ...
        <!--edit modal-->
        <c:forEach var="setting" items="${settingList}">
            <div class="modal fade" id="editSettingModal_${setting.getSettingID()}" tabindex="-1" role="dialog" aria-labelledby="editSettingModalLabel_${setting.getSettingID()}" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editSettingModalLabel_${setting.getSettingID()}">Edit Setting</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <form action="setting" method="post">
                                ...
                                <input type="hidden" name="settingId" value="${setting.getSettingID()}">
