                ...
                <div class="col-sm-9 m-auto"> <%-- show sản phẩm --%> 
                    <div class="row text-center">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-3">
                                                <div class="card">
                                                    <img class="card-img-top" src="<%=n5.getImage()%>" alt="Card image cap">
                                                    <div class="card-body">
                                                        <p class="card-title show_txt"><a class="text-decoration-none" href="detail?pid=<%=n5.getProductID()%>" title="View Product"><%=n5.getTitle()%></a></p>
                                                        <p class="card-text show_txt"><%=n5.getBriefInfo()%></p>
                                                        <div class="row">                              
                                                            <div class="col">
                                                                <del class="card-text text-muted me-2"><%=n5.getPrice()%>Đ</del> <h3 class="card-text"><%=n5.getSalePrice()%>Đ</h3> 
                                                            </div>
                                                            <div class="col">
                                                                <a href="show?id=<%=n5.getProductID()%>&name=<%=n5.getTitle()%>&image=<%=n5.getImage()%>&price=<%=n5.getPrice()%>&salePrice=<%=n5.getSalePrice()%>" class="btn btn-dark btn-block">Add to cart</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
