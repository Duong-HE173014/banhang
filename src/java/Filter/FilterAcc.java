...
public class FilterAcc implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (Arrays.asList("/cart","/home","/products","/showCart", "/login", "/logout", "/blog","/detail1","/blogsearch","/blogcategory","/category","/detail","/postDetail","/register","/verify","/search", "/reset-password", "/new-password","/css/style.css").contains(currentPath)) {
